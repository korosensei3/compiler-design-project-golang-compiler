...
%left T_LAND T_LOR
%left T_EQL T_NEQ T_LEQ T_GEQ T_LSR T_GTR
%token T_LEFTPARANTHESES T_RIGHTPARANTHESES T_LEFTBRACE T_RIGHTBRACE T_LEFTBRACKET T_RIGHTBRACKET T_COMMA T_PERIOD T_SEMICOLON
...
Expression:
	...
	| unary_op Operand {$$=$2;}
	| Operand {$$=$1;}
    | T_LEFTPARANTHESES Expression T_RIGHTPARANTHESES {$$=$2;};
